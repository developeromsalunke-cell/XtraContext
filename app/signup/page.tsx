    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-[#0A0A0A] text-white font-sans selection:bg-[#FF5733]/30">
      ...
      <div className="md:w-[45%] bg-[#080808] border-r border-white/[0.06] flex flex-col items-center justify-center p-12 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <h2 className="text-xl font-medium text-gray-300 mb-3">Build Your Universal Memory</h2>
          <p className="text-xs text-gray-500 uppercase tracking-[0.2em] font-mono font-bold border border-white/10 bg-white/5 px-4 py-1.5 rounded-full">
            The architectural layer for AI
          </p>
        </div>
      ...
      <div className="md:w-[55%] flex items-center justify-center p-8 md:p-16 relative">
        <div className="w-full max-w-md space-y-10 relative z-10">
          <div className="space-y-3">
            ...
            <p className="text-gray-400 text-sm font-medium">Start capturing your AI memory today.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              disabled={loading}
              type="submit"
              className="w-full bg-[#FF5733] hover:bg-[#ff6c4d] text-black font-black uppercase text-xs tracking-[0.2em] py-4 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 group mt-2 cursor-pointer"
            >
              {loading ? (
                <>
          ...
          <p className="text-center text-sm text-gray-500 pt-4">
            Already registered?{" "}
            <Link href="/login" className="text-white font-bold hover:text-[#FF5733] transition-colors underline decoration-white/30 underline-offset-4">
              Sign In
            </Link>
          </p>
          
          <p className="text-[10px] text-center text-gray-600 uppercase tracking-widest font-mono leading-relaxed pb-4">
